...
$sql="CREATE TABLE tck_member(uid int NOT NULL,username varchar(15),password varchar(200))";
$mysql=new mysql_server("127.0.0.1","root","","test");
$mysql->sql_operator($sql);

?>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>Install</title><link rel="stylesheet" type="text/css" href="../theme/main.css"><div id="comment"><h2>配置完成！</h2><p>You have been succeed to install it!</p>
<p>&nbsp;</p></div><div id="config"><p align="center">Bug请反馈到1948638989@qq.com </p></div>
